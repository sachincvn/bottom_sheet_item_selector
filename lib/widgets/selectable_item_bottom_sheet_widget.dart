import 'package:bottom_sheet_item_selector/widgets/sharp_divider_painter.dart';
                        ...
                        if (widget.canSearchItems)
                          Padding(
                            ...
                            child: TextField(
                              ...
                              style: const TextStyle(fontSize: 12, fontWeight: FontWeight.w500, color: Color(0xFF292A2B)),
                              onChanged: (value) {
                                setState(() {
                                  _searchItems(value);
                                });
                                ...
                                children: [
                                  ListTile(
                                    ...
                                    title: Text(
                                      ...
                                      style: TextStyle(
                                        color: _tempSelectedItems.contains(item) ? const Color(0xFF50BEA7) : const Color(0xFF777777),
                                      ),
                                    ),
                                    trailing: _tempSelectedItems.contains(item)
                                        ? Container(
                                            ...
                                            decoration: BoxDecoration(
                                              ...
                                              border: Border.all(color: const Color(0xFF50BEA7), width: 1.5),
                                            ),
                                            child: const Icon(
                                              Icons.check_rounded,
                            ...
                            child: Row(
                              ...
                              children: [
                                ...
                                ElevatedButton(
                                  ...
                                  style: ElevatedButton.styleFrom(shape: RoundedRectangleBorder(borderRadius: BorderRadius.circular(4)), backgroundColor: const Color(0xFF292A2B)),
